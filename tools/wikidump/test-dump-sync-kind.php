...
// mirroring define() shims -- identical to the dry-run test. A shim here
// previously masked the live gap where api/edit/wiki/dump.php's require graph
// never defined these (settlement conflict-analysis phase -> HTTP 500).
