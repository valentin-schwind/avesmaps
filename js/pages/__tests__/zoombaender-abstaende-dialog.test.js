...
// ---- 1. Die drei Regler stehen im Markup, mit den geforderten Schranken -------------------------
...
assert.ok(/AVESMAPS_ZOOM_BANDS_SPACING_LIMITS\s*=\s*\[0\.0, 20\.0\]/.test(bibliothek),
	"der Server kennt dieselbe Schranke (0 bis 20)");
...
assert.ok(/abstaende:\s*\{\s*spalt:\s*4,\s*repel:\s*2,\s*versatz:\s*8\s*\}/.test(vorgabetafel),
	"die Vorgabewerte (4/2/8, die heutigen Konstanten) stehen in der Vorgabetafel");
