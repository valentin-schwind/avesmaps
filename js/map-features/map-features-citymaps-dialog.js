...
(function initCitymapsDialog() {
	...
	function ensureDialog() {
		...
		overlay.innerHTML = '<div class="avesmaps-adv-dialog__box avm-fenster avm-fenster--werkzeug" role="dialog" aria-modal="true">'
			...
			+ '<button type="button" class="avesmaps-adv-dialog__close avm-fenster__knopf avm-fenster__knopf--gefasst" aria-label="' + esc(tr("cityMaps.closeAria", "Schließen")) + '">✕</button></div>'
