...
const locationCanvasLayer = {
	...
	_starteGroessenGegenrechnung(zielZoom, massstab) {
		...
		const schritt = () => {
			...
			// Der Zeichenvorgang selbst kostet nur 0,2 ms (gemessen), aber jeder davon laedt die
			// ganze Canvas neu zur Grafikkarte hoch -- live 3176x1907 Pixel. Das ist der Posten,
			// den man nicht auf dem Hauptthread sieht, und der Grund, warum hier nicht stumpf
			// jedes Bild gezeichnet wird.
