...
function openLabelEditDialog(options = {}) {
	...
	if (quellenHost && typeof mountFeatureSourceEditor === "function") {
		...
		// Flaeche gebunden, wird HIER nicht montiert -- der Kasten der Flaeche traegt sie, und ein zweiter Kasten
		// mit derselben Liste laese sich wie zwei Ablagen. Eine freie Beschriftung montiert wie bisher auf
		// `region` + public_id.
		// 🔴 SICHTBAR MACHT DIESE STELLE NICHTS MEHR (Owner 03.09.2026). Beide Behaelter stehen im Reiter
		// „Wiki & Quellen", und wessen Kasten gilt, entscheidet avesmapsLandschaftDialogQuellenKasten
		// (landschaft-dialog.js) -- dort, wo die Haelften sich an- und abmelden, genau wie beim Wiki-Kasten
		// daneben. Bis dahin stand hier ein Verweis „… sie stehen im Abschnitt Fläche"; der Owner hat den
		// Import fuer leer gehalten, weil er im Reiter nachsah, der „Quellen" heisst, und dort nur den Verweis
		// fand. Ein zweiter Sichtbarkeitsgeber hier waere die Divergenz, die das gerade beseitigt hat.
