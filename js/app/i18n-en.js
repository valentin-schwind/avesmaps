...
window.AVESMAPS_I18N_EN = {
	...
	"planner.route.fastest": "Fastest",
	"planner.route.fastest.title": "Finds the fastest route",
	"planner.route.shortest": "Shortest",
	...
	"transport.speedInfo.slopeRule": "<b>Slope.</b> What counts is the <em>steepness in percent</em>, not the height difference. The model is the <b>Leistungskilometer</b> (DIN 33466), the marching-time arithmetic of the German and Swiss alpine clubs: one mile of level ground is one performance mile, every 100 Schritt of climb adds another, and every 150 Schritt of descent does too — but only on slopes steeper than 20 %. So a leg takes <b>half again as long at 5 %, twice as long at 10 %, three times at 20 %</b>; past 30 % it stops at four times. <b>Descending costs nothing while it stays gentler than 20 % — and it is never quicker than the level.</b> Crossing the Koschberge pass (24 %), an imperial road drops to about 1.3 instead of 4.5 miles/h. On rivers and at sea terrain does not count — there the current alone decides. Where no heights are recorded only the way type counts; the leg infobox then shows no „climb and descent“ line either. ⚠️ The 20 % threshold is decided per stretch, not from a leg's average: real ground is not smooth, so a leg can be a little slower than the rule of thumb for its average gradient suggests.",
