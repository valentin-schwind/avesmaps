...
window.AVESMAPS_I18N_EN = {
	...
	"planner.travellersLabel": "Travellers:",
	"planner.travellers.title": "Number of travellers. Mounts follow from the mode of transport and are not entered separately.",
	"planner.cost.heading": "Travel costs",
	...
	"planner.cost.mounts": "Mounts",
	"planner.cost.mounts.own": "{n} animals, own fodder and shoeing",
	"planner.cost.mounts.stable": "{n} animals stabled, plus shoeing",
	...
	"planner.cost.party": "{p} travellers",
	"planner.cost.party.mounted": "{p} travellers, {m} mounts",
	"planner.cost.free": "—",
