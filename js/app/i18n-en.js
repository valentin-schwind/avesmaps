...
window.AVESMAPS_I18N_EN = {
	...
	"legal.liability.content.body": "The content of this website is created with the greatest possible care. However, no guarantee is given for its accuracy, completeness or timeliness, and liability for damage arising from the use or non-use of the information provided is excluded. The operator is responsible for their own content under the general laws, but is not obliged to monitor transmitted or stored third-party information or to investigate circumstances that indicate unlawful activity.",
	...
	"legal.wappen.body": "The coats of arms of the territories shown on the map are taken from Wiki Aventurica (imported via its \"Wappen-Link\" field). Only coats of arms classified as public domain are displayed; coats with an unknown or restrictive license status remain hidden. The rights to the coats of arms remain with their respective creators and rights holders; their display on Avesmaps does not establish any rights to them. Upon notice from rights holders, the coats of arms concerned are reviewed and, where necessary, removed or adjusted.",
	...
	"legal.contact.title": "Write us a message",
