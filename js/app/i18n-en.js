...
window.AVESMAPS_I18N_EN = {
	...
	"legal.mapMaterial.body": "The interactive map is based on edited map material and the location, path and geometry data derived from it. Insofar as official DSA map material from Ulisses is used, this is done exclusively in accordance with the license and usage terms applicable to fan projects from Ulisses, where these are applicable. Edits to the map material serve exclusively the technical implementation as an interactive map and non-commercial use in the context of Das Schwarze Auge.",
