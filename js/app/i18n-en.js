...
window.AVESMAPS_I18N_EN = {
	...
	"planner.transport.opt.caravan": "Caravan (3.1 mph)",
	"planner.transport.opt.groupFoot": "Group on foot (3.1 mph)",
	"planner.transport.opt.lightWalker": "On foot, light luggage (4.1 mph)",
	"planner.transport.opt.horseCarriage": "Horse carriage (5.1 mph)",
	"planner.transport.opt.groupHorse": "Group on horseback (3.6 mph)",
	"planner.transport.opt.lightRider": "Rider, light luggage (5.1 mph)",
