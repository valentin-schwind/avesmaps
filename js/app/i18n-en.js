...
window.AVESMAPS_I18N_EN = {
	...
	"legal.privacy.community.lead": "Privacy – Community reports and ratings.",
	"legal.privacy.community.body": "If you voluntarily submit a location report, correction or rating, the data you enter (such as a self-chosen name and the content of your submission) is processed in order to review it editorially and, where appropriate, display it on the map. The legal basis is your consent and the legitimate interest in operating the map (Art. 6(1)(a) and (f) GDPR). Submitting does not guarantee publication.",
