...
window.AVESMAPS_I18N_EN = {
	...
	"transport.speedInfo.slopeRule": "<b>Slope.</b> What counts is the <em>steepness</em>, not the height: 240&nbsp;Schritt of climb over one mile weigh heavily, the same 240 over ten miles barely at all. As a rule of thumb uphill: <b>every 100&nbsp;Schritt of climb per mile makes the leg about half again as long</b> — 200&nbsp;Schritt twice as long, and terrain can never cost more than <b>four times</b> the time. Downhill is fastest at a drop of roughly 250&nbsp;Schritt per mile (just under a fifth off); steeper brakes again, and beyond some 500&nbsp;Schritt per mile it is slower than level ground. Crossing the Koschberge pass, an imperial road drops to about 2 instead of 4.5&nbsp;miles/h. On rivers and at sea terrain does not count — there the current alone decides. Where no heights are recorded only the way type counts; the leg infobox then shows no „climb and descent“ line either.",
