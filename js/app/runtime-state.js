...
let locationData = [],
	...
	// Die VORIGE Route, gedimmt, solange die neue berechnet wird (retireCurrentRouteLineAsStale,
	// route-render.js). Bewusst NICHT currentRouteLayer: wer die aktuelle Route liest, sieht dann keine.
