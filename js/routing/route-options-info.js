	...
	function restCard() {
		...
		return card("icons/Rast.webp",
			...
			+ '<p class="roi-text">' + tx("planner.optionsInfo.rest.note",
				"<b>Nur der Schnellsegler fährt durch</b> — Lastensegler und Galeere ankern nachts und rasten wie an Land. Das Feld gilt für Landreisen; Fluss und See fahren ihren eigenen Reisetag von 12 Stunden. Die 8 Stunden an Land nennt „Wege des Entdeckers“ (S. 160–162), die 12 auf dem Wasser die Geographia (S. 129 · 131).") + "</p>");
	}
