...
(function () {
	...
	function dialogHtml() {
		return (
			...
			"</div>" +
			'<div class="tsi-rules">' +
			'<div class="tsi-rule">' + iconImg("icons/Rast.webp") + "<div>" + tr("transport.speedInfo.restRule", "<b>Rast.</b> An Land 8 Reisestunden am Tag und 16 Stunden Rast (im Planer einstellbar), auf Fluss und See 12 und 12 — <b>nur der Schnellsegler</b> fährt rund um die Uhr. <b>Gerechnet wird aus der Tagesleistung: Tempo = Tagesleistung ÷ Reisestunden.</b> Eine Reisegruppe zu Fuß macht 30 Meilen am Tag, ein Einzelreiter 50, ein Lastensegler 120. Woher: die 8 Stunden aus „Wege des Entdeckers“ S. 160–162, die 12 aus der Geographia S. 129 (Fluss) und S. 131 (See), die Tagesleistungen aus der Geographia S. 123 · 129 · 131.") + "</div></div>" +
