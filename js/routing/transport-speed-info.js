...
(function () {
	...
	const CSS = `
.tsi-info-btn{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;margin-left:6px;padding:0;border:0;background:transparent;color:#0078a8;cursor:pointer;vertical-align:middle;line-height:0;}
.tsi-info-btn:hover{color:#1a9fd4;}
