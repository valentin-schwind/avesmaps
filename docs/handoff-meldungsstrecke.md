...
Gegenprüfung. **14 AKUT sind erledigt** (im Bericht mit ✅ und Commit markiert), 20 offen. ⚠️ A10 und A17/A18 sahen kurz erledigt aus und sind es nicht — beide Reparaturversuche wurden zurueckgenommen (siehe dort). ⚠️ A10 sah kurz erledigt aus und ist es nicht: der Reparaturversuch zerstoerte Daten und wurde zurueckgenommen (siehe dort).
