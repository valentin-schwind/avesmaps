...
Ziel: kontrollierter, verhaltensneutraler Split der Region-Tabs-/Payload-State-Helfer aus js/dialogs-review.js in eine neue Datei js/review/review-region-tabs-payload.js.

Erlaubte Änderungen:
- js/dialogs-review.js
- neue Datei js/review/review-region-tabs-payload.js
- index.html
...
Verschiebe ausschließlich diese Funktionen aus js/dialogs-review.js nach js/review/review-region-tabs-payload.js, unverändert und in sinnvoller Reihenfolge:
- getRegionEditTabKey
- initializeRegionEditTabs
- getPrimaryRegionGeometryPublicId
- renderRegionEditTabs
...
- neuen stabilen Split js/review/review-region-tabs-payload.js dokumentieren
...
- Suche nach fehlenden Referenzen/Typo bei js/review/review-region-tabs-payload.js in index.html.
- Syntaxprüfung:
  - node --check js/review/review-region-tabs-payload.js
  - node --check js/dialogs-review.js

Danach:
- git status zeigen
- git add index.html js/dialogs-review.js js/review/review-region-tabs-payload.js docs/refactoring-status.md
