...
- Dialog-Review-Split ist jetzt in zehn stabile Schichten getrennt, mit klassischer Script-Reihenfolge in `index.html`:
...
- `js/dialogs-review.js` bleibt stabil als Rest-Orchestrator fuer Region-/Territory-Parent/Assignment/Submit-Flows, Submit-/API-/Init-Logik und verbleibende Hilfsfunktionen.
...
- Region-Wiki-Picker-Smoke empfohlen/offen, falls noch nicht gemeldet.
...
- Zuerst Region-Wiki-Picker-Smoke (und ggf. offenen Core-Smoke) abschliessen.
- Danach Restdatei (`js/dialogs-review.js`) neu analysieren.
- Naechster Analysebereich bevorzugt Region/Territory-Parent/Assignment/Submit.
