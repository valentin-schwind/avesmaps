...
- Verlauf: 05.09.2026 angelegt (Analyse, Rangwert 703656) · 06.09.2026 nachgezogen: `2211f8d3e` hat drei Hunks bei Z. 843/2756/3959 -- alle ausserhalb des Blocks; Block an den Namen unveraendert zusammenhaengend und frei, nur um +5 Zeilen gewandert · 06.09.2026 nachgezogen: `289d0b2a9` haengt acht Zeilen bei Z. 2749 an -- weit ausserhalb des Blocks; Block an den Namen unveraendert zusammenhaengend und frei, Zeilennummer unveraendert · 09.09.2026 nachgezogen: 80cb6bbeb (die Schreiber des Merkers fallen) hat die Datei bewegt; Block an den Namen unveraendert zusammenhaengend und frei · 15.09.2026 nachgezogen: 46981a607 („Zuletzt gesynct“ liest ueberall die Serverkarte) hat die Datei bewegt; Block an den Namen unveraendert zusammenhaengend und frei · 20.09.2026 erledigt (91e4ff39e): -> js/review/review-wiki-sync-dump-report.js, 4053 -> 3772 Zeilen (wc -l); die 282 Blockzeilen byte-gleich, Fingerabdruck 294/282 = 4,1 %. Der Merker avesmapsDumpReportStylesInjected und avesmapsOpenDumpReport blieben drueben; <script> am Ende desselben <template data-nur-editor>, dessen document.write die Reihenfolge erzwingt. Testfeld identisch zur Nulllinie (643 JS / 455 PHP). Drei Agenten: Widerleger und Testbindung ohne Fund, Behauptung blockte eine falsche Zahl (Werkzeuglauf war NACH dem Schnitt gemessen) -- gegen einen Referenz-Worktree neu gemessen und korrigiert. Live belegt: Deploy-Lauf 35494854077 success, beide js-Dateien Hash-gleich zum Commit, index.html traegt review-wiki-sync-dump-report.js?v=2ab13ce2dd (HTTP 200).

### P-002 · js/review/review-wiki-sync.js · Verfahren A
- Status: offen
- Stand: 91e4ff39e · Blob: 3bc530cd32c39ccf30d2e6e983258388de928e51
- Block: „Sync-Läufe je Objektart und Publikationen“ — setWikiSyncKindStatus … runWikiSyncPublicationsSyncLoop (6 Funktionen, ~283 Zeilen ab Z. 1467)
...
- Verlauf: 05.09.2026 angelegt (Analyse, Rangwert 703656) · 06.09.2026 nachgezogen: `2211f8d3e` hat drei Hunks bei Z. 843/2756/3959 -- alle ausserhalb des Blocks; Block an den Namen unveraendert zusammenhaengend und frei, nur um +5 Zeilen gewandert · 06.09.2026 nachgezogen: `289d0b2a9` haengt acht Zeilen bei Z. 2749 an -- weit ausserhalb des Blocks; Block an den Namen unveraendert zusammenhaengend und frei, Zeilennummer unveraendert · 09.09.2026 nachgezogen: 80cb6bbeb (die Schreiber des Merkers fallen) hat die Datei bewegt; Block an den Namen unveraendert zusammenhaengend und frei · 15.09.2026 nachgezogen: 46981a607 („Zuletzt gesynct“ liest ueberall die Serverkarte) hat die Datei bewegt; Block an den Namen unveraendert zusammenhaengend und frei · 20.09.2026 nachgezogen: der eigene Schnitt P-001 (91e4ff39e) hat 282 Zeilen davor entfernt; Block an den Namen unveraendert zusammenhaengend und frei (block.frei true), nur von Z. 1726 auf Z. 1467 gewandert
