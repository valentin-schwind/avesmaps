...
`index.html` laedt die neue Datei im Map-Features-Block nach `js/map-features/map-features-display-mode.js` und vor `js/map-features/map-features-feature-state.js`:

```html
<script src="js/map-features/map-features-display-mode.js"></script>
<script src="js/map-features/map-features-location-marker-rendering.js"></script>
<script src="js/map-features/map-features-feature-state.js"></script>
```

Diese Reihenfolge ist akzeptabel, weil `js/map-features/map-features-location-marker-rendering.js` keine Feature-State-Funktionen nutzt und beide Dateien vor `js/map-features.js` geladen werden.
...
```text
node --check js/map-features/map-features-location-marker-rendering.js
...
Der Location-Marker-Rendering-Split bleibt stabil. Die Datei `js/map-features/map-features-location-marker-rendering.js` soll nicht ohne neue Boundary erweitert werden.
