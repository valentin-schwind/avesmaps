...
const AVESMAPS_REPORT_TYPES = [
    ...
    'inselgruppe' => ['type' => 'label', 'subtype' => 'inselgruppe'],
    'gebirge' => ['type' => 'label', 'subtype' => 'gebirge'],
    'berggipfel' => ['type' => 'label', 'subtype' => 'berggipfel'],
    'vulkan' => ['type' => 'label', 'subtype' => 'vulkan'],
    // 01.09.2026, Editorenwunsch: drei freie Label-Arten in der Familie von Berggipfel und Vulkan.
    // (Die damals vierte, `vorgebirge_mittelgebirge`, ist am 09.09.2026 auf Owner-Entscheid gestrichen.)
