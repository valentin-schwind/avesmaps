...
// Bibliothek erst DANACH einbindet (Kommentar oben, Zeile 24). Der (inzwischen zurueckgebaute)
// Garetien-Importer war der erste Aufrufer von avesmapsCreatePointFeature ausserhalb jenes
// Endpunkts und bekam dafuer "Undefined constant AVESMAPS_LOCATION_SUBTYPES" statt eines
// angelegten Ortes -- derselbe Fatal-Error-statt-Fehlermeldung-Fehler wie bei
...
// „bewusst abgehakt", und jede Wiederholung haette jedes bewusste „aus" wieder angehakt.
// ⭐ Seine zwei Lehren gelten fuer jeden kuenftigen Bestandslauf ueber properties_json: lesen IN der Transaktion mit `FOR UPDATE`
// plus Revisionsriegel im UPDATE (sonst geht ein gleichzeitiges Speichern verloren), und keine Protokollzeile je Zeile (die Kappung
// je Person auf 200 loeschte die echte Aenderungsgeschichte). Stand: Commit 81f25352d. Waechter:
// api/_internal/map/__tests__/wegname-bestandslauf-zurueckgebaut-test.php.
