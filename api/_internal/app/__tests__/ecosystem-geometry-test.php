...
// ---- the type vocabulary -----------------------------------------------------------------------------
// The owner's V2.1 checkpoint counts 16 rows in phpMyAdmin (4 + 5 + 7); this is the same count, checkable
// without a database.

assert(count(AVESMAPS_ECOSYSTEM_REGION_TYPE_SEED) === 16, 'the seed is 16 rows');
...
assert(count($byKind['vegetation']) === 7, 'vegetation: 7');
