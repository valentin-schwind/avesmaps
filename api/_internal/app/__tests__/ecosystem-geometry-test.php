...
// without a database. 19 since 2026-07-28: 'flussland_flusstal', 'dschungel' and 'wuestenoase' joined the vegetation vocabulary (owner).
//
...
assert(count(AVESMAPS_ECOSYSTEM_REGION_TYPE_SEED) === 19, 'the seed is 19 rows');
