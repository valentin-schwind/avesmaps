...
// without a database. 22 since 2026-07-29: 'flussland_flusstal', 'dschungel' and 'wuestenoase' joined the vegetation vocabulary and
// 'wadi', 'schlucht' and 'hochebene' the topographic one (owner).
//
...
assert(count(AVESMAPS_ECOSYSTEM_REGION_TYPE_SEED) === 22, 'the seed is 22 rows');
...
assert(count($byKind['topographie']) === 8, 'topographie: 8');
