...
// without a database. 23 since 2026-07-29: 'flussland_flusstal', 'dschungel' and 'wuestenoase' joined the vegetation vocabulary and
// 'wadi', 'schlucht', 'hochebene' and 'tiefebene' the topographic one (owner).
//
...
assert(count(AVESMAPS_ECOSYSTEM_REGION_TYPE_SEED) === 23, 'the seed is 23 rows');
...
assert(count($byKind['topographie']) === 9, 'topographie: 9');
