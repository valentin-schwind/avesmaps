...
assert(avesmapsZoomBandsValidate(['marker' => [], 'label' => [], 'abstaende' => ['spalt' => 150.5]]) === null,
    'ueber der Schranke: 150,5 px');
// Die Obergrenze selbst ist einschliesslich (<=), nicht ausschliesslich -- wie bei marker/label.
assert(avesmapsZoomBandsValidate(['marker' => [], 'label' => [], 'abstaende' => ['spalt' => 150.0]]) !== null,
    'genau 150 px ist noch gueltig');
// 🔴 22.08.2026 -- DIE SCHRANKE HIER IST DIE WEITESTE, NICHT DIE ENGSTE. Seit der Drift-Deckel
// (0-150) dazugekommen ist, kann der Server nicht mehr je Schluessel pruefen: er fuehrt bewusst
