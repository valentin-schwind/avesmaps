...
// Location support helpers + map-feature plumbing live in a sibling file (M5 split).
...
require_once __DIR__ . '/locations-faelle.php';
...
function avesmapsWikiSyncBuildLocationProperties(
    ...
    if ($wikiUrl === '') {
        ...
        // 🔴 HIER RAEUMTE DAS ZUWEISEN DEN MERKER WEG. Gefallen am 09.09.2026 mit
...
function avesmapsWikiSyncLocationFeatureNeedsUpdate(
    ...
    return (string) ($feature['name'] ?? '') !== $name
        ...
        // 🔴 HIER STAND „DER WIDERSPRUCH IST EINE AENDERUNG" -- ein Ort mit Adresse UND Merker
        // galt als aenderungsbeduerftig, damit das Aufloesen ihn heilen konnte. Der Merker ist am
        // 09.09.2026 gefallen (Owner-Entscheid); der Widerspruch kann nicht mehr entstehen.
