...
// ---------------------------------------------------------------- DROSSEL ---
// 🔴 Die 20 Sekunden stehen in IHRER robots.txt, Abschnitt „User-agent: AvesmapsWikiSync" --
// derselbe Abschnitt, der uns `/de/api.php` ueberhaupt erst erlaubt. Wer sie senkt, senkt sie
// gegen eine fremde Hausordnung.
$pruefe(AVESMAPS_WIKI_REQUEST_DELAY_MICROSECONDS >= 20000000, "die Drossel haelt den Crawl-delay 20 aus IHRER robots.txt ein");
...
avesmapsWikiSyncThrottleWikiRequest(300000);
...
$pruefe($zweiteDauer >= 0.25, sprintf("die zweite Anfrage haelt den Abstand ein (gemessen %.3f s bei 0,3 s Testabstand)", $zweiteDauer));
